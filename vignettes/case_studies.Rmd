---
title: 'Batch Effects Management in Case Studies'
author: 
- 'Yiwen (Eva) Wang'
...
```{r ADpcaBefore, fig.align = 'center', fig.cap = 'Figure 1: The PCA sample plot with densities in the AD data.'}
# AD data
...
```{r ADboxBefore, out.width = '60%', fig.align = 'center', fig.cap = 'Figure 2: Boxplots of sample values in "OTU28" before batch effect correction in the AD data.'}
...
```{r ADdensityBefore, out.width = '60%', fig.align = 'center', fig.cap = 'Figure 3: Density plots of sample values in "OTU28" before batch effect correction in the AD data.'}
...
```{r ADheatmap, out.width = '90%', fig.align = 'center', fig.cap = 'Figure 4: Hierarchical clustering for samples in the AD data.'}
...
```{r ADlm, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 5: Diagnostic plots for the model fitted with batch effects of "OTU12" in the AD data.'}
# AD data
...
```{r HDlmm, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 6: Diagnostic plots for the model fitted with batch effects of "OTU1" in the HD data.'}
...
```{r ADpca, fig.height = 17, fig.width = 12, out.width = '100%', echo = FALSE, fig.align = 'center', fig.cap = 'Figure 7: The PCA sample plots with densities before and after batch effect correction in the AD data.'}
...
```{r ADprda, fig.height = 6, fig.align = 'center', fig.cap = 'Figure 8: Global explained variance before and after batch effect correction for the AD data.'}
# AD data
...
```{r HFHSprda, fig.height = 6, fig.align = 'center', fig.cap = 'Figure 9: Global explained variance before and after batch effect correction for the HFHS data.'}
# HFHS data
data('HFHS_data')
...
```{r ADr2_1, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 10: AD study: $R^2$ values for each microbial variable before and after batch effect correction.'}
# AD data
# scale
...
```{r ADr2_2, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 11: AD study: the sum of $R^2$ values for each microbial variable before and after batch effect correction.'}
##################################
ad.barp.list <- list()
for(i in seq_len(length(ad.r_values.list))){
...
```{r ADalignment, fig.align = 'center', fig.cap = 'Figure 12: Comparison of alignment scores before and after batch effect correction using different methods for the AD data.'}
# AD data
ad.scores <- c()
...
```{r ADupsetR, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 13: UpSet plot showing overlap between variables selected from different corrected data for the AD study.'}
