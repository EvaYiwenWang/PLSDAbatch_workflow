...
The `r colorize("sponge data", "brown")` have a completely balanced batch x treatment design, so there was no intersection variance (indicated in line `[b]`, Adj.R.squared = -0.01). The proportion of treatment and batch variance was nearly equal as indicated in lines `[a]` and `[c]`.
