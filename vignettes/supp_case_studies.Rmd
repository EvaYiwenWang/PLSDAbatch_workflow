...
```{r SpongepcaBefore, fig.align = 'center', fig.cap = 'Figure 1: The PCA sample plot with densities in the sponge data.'}
...
```{r Spongeheatmap, out.width = '90%', fig.align = 'center', fig.cap = 'Figure 2: Hierarchical clustering for samples in the sponge data.'}
...
```{r Spongelm, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 3: Diagnostic plots for the model fitted with batch effects of "OTU2" in the sponge data.'}
...
```{r Spongepca, fig.height = 13, fig.width = 12, out.width = '100%', echo = F, fig.align = 'center', fig.cap = 'Figure 4: The PCA sample plots with densities before and after batch effect correction in the sponge data.'}
...
```{r Spongeprda, fig.height = 6, fig.align = 'center', fig.cap = 'Figure 5: Global explained variance before and after batch effect correction for the sponge data.'}
...
```{r Sponger2_1, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 6: Sponge study: $R^2$ values for each microbial variable before and after batch effect correction.'}
# scale
...
```{r Sponger2_2, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 7: Sponge study: the sum of $R^2$ values for each microbial variable before and after batch effect correction.'}
##################################
...
```{r Spongealignment, fig.align = 'center', fig.cap = 'Figure 8: Comparison of alignment scores before and after batch effect correction using different methods for the sponge data.'}
sponge.var = 0.95
sponge.k = 3
...
```{r SpongeupsetR, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 9: UpSet plot showing overlap between variables selected from different corrected data for the sponge study.'}
...
```{r HFHSpcaBefore1, fig.align = 'center', fig.cap = 'Figure 10: The PCA sample plot with densities coloured by cages in the HFHS data.'}
...
```{r HFHSpcaBeforeNew1, fig.align = 'center', fig.cap = 'Figure 12: The PCA sample plot with densities coloured by cages in the reduced HFHS data.'}
...
```{r HFHSpcaBeforeNew2, fig.align = 'center', fig.cap = 'Figure 13: The PCA sample plot with densities coloured by days in the reduced HFHS data.'}
...
```{r HFHSheatmapS, out.width = '90%', fig.align = 'center', fig.cap = 'Figure 14: Hierarchical clustering for samples in the HFHS data.'}
# scale the clr data on both OTUs and samples
...
For the day and diet effects, the batch x treatment design is balanced. There was no intersection variance (indicated in line `[b]`, Adj.R.squared = 0). The proportion of treatment variance was much higher than batch variance as indicated in lines `[a]` (Adj.R.squared = 0.272) and `[c]` (Adj.R.squared = 0.036).
...
```{r HFHSlm, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 15: Diagnostic plots for the model fitted with the day effect of "OTU 541135" in the HFHS data.'}
...
```{r HFHSlmm, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 16: Diagnostic plots for the model fitted with the day and cage effects of "OTU541135" in the HFHS data.'}
...
```{r HFHSpca, fig.height = 17, fig.width = 12, out.width = '100%', echo = F, fig.align = 'center', fig.cap = 'Figure 17: The PCA sample plots with densities before and after batch effect correction in the HFHS data.'}
...
```{r HFHSprda, fig.height = 6, fig.align = 'center', fig.cap = 'Figure 18: Global explained variance before and after batch effect correction for the HFHS data.'}
# HFHS data
...
```{r HFHSr2_1, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 19: HFHS study: $R^2$ values for each microbial variable before and after batch effect correction.'}
# scale
...
```{r HFHSr2_2, fig.height = 10, fig.width = 14, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 20: HFHS study: the sum of $R^2$ values for each microbial variable before and after batch effect correction.'}
##################################
hfhs.barp.list <- list()
for(i in seq_len(length(hfhs.r_values.list))){
  hfhs.barp.list[[i]] <- 
...
```{r HFHSalignment, fig.align = 'center', fig.cap = 'Figure 21: Comparison of alignment scores before and after batch effect correction using different methods for the HFHS data.'}
# HFHS data
hfhs.var = 0.95
hfhs.k = 15
...
```{r, HFHSupsetR, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 22: UpSet plot showing overlap between variables selected from different corrected data for the HFHS study.'}
...
```{r HDpcaBefore, fig.align = 'center', fig.cap = 'Figure 23: The PCA sample plot with densities in the HD data.'}
# HD data
...
```{r, HDheatmap, out.width = '90%', fig.align = 'center', fig.cap = 'Figure 24: Hierarchical clustering for samples in the HD data.'}
# scale the clr data on both OTUs and samples
...
In the result, `X1` and `X2` represent the first and second covariates fitted in the model. `[a]`, `[c]` represent the independent proportion of variance explained by `X1` and `X2` respectively, and `[b]` represents the intersection variance shared between `X1` and `X2`. Collinearity was detected in the `r colorize("HD data", "violet")` between treatment and batch as indicated by lines `[a]` and `[b]` that all treatment variance (`[a]`: Adj.R.squared = 0, `[b]`: Adj.R.squared = 0.0973) was explained as intersection variance. The batch x treatment design in the `r colorize("HD data", "violet")` is nested, in such a design the intersection variance is usually considerable. As the intersection is shared between batch and treatment effects, the batch variance in the `r colorize("HD data", "violet")` is larger than the treatment variance.
...
```{r HDlmmS, fig.height = 13, fig.width = 12, out.width = '100%', fig.align = 'center', fig.cap = 'Figure 25: Diagnostic plots for the model fitted with the cage effect of "OTU1" in the HD data.'}
