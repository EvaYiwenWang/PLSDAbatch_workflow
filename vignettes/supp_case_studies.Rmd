...
```{r Spongepca, fig.height = 17, fig.width = 12, out.width = '100%', echo = F, fig.align = 'center', fig.cap = 'The PCA sample plots with densities before and after batch effect correction in the sponge data.'}
...
```{r Sponger2, fig.height = 8, fig.width = 7, out.width = '100%', fig.align = 'center', fig.cap = '$R^2$ values for each microbial variable before and after batch effect correction in the sponge data.'}
# scale
...
```{r HFHSr2, fig.height = 8, fig.width = 7, out.width = '100%', fig.align = 'center', fig.cap = '$R^2$ values for each microbial variable before and after batch effect correction in the HFHS data.'}
# scale
